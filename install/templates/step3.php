      ...
      <div class="server">
        <table width="100%">
          ...
          <tr>
            ...
            <td><input type="text" name="dbname" id="dbname" value="ZTfx2.0" class="input" onBlur="TestDbPwd(0)"></td>
		...
		<table width="100%">
          ...
          <tr>
            ...
            <td><input type="text" name="sitename" value="ZTfx开源商城" class="input"></td>
          ...
          <tr>
            ...
            <td><input type="text" name="sitekeywords" value="ZTfx,b2c商城系统，thinkphp" class="input" autoComplete="off"></td>
            <td><div id="J_install_tip_sitekeywords"></div></td>
          </tr>
          <tr>
            <td class="tar">商城描述：</td>
            <td><input type="text" name="siteinfo" class="input" value="ZTfx的开发旨在帮助创业者搭建企业网站平台，实现创业梦想。"></td>
