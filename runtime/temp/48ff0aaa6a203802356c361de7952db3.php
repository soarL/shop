<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:46:"./application/admin/view2/user\remittance.html";i:1499420862;s:44:"./application/admin/view2/public\layout.html";i:1499420862;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
    ...
    <div class="flexigrid">
        <div class="mDiv">
            ...
            <form class="navbar-form form-inline" id="search-form" method="get" action="<?php echo U('/Admin/User/remittance'); ?>" onsubmit="return check_form();">
                ...
                <div class="sDiv">
                    ...
                    <div class="sDiv2" style="margin-right: 10px;">
                        <input size="30" id="user_id" placeholder="用户id" value="<?php echo \think\Request::instance()->request('user_id'); ?>" name="user_id" class="qsbox" type="text">
                    </div>
                    <div class="sDiv2" style="margin-right: 10px;">
        ...
        <!--<div class="tDiv">-->
            <!--<div class="tDiv2">-->
                <!--<div class="fbutton"> <a href="<?php echo U('Finance/ajax_remittance',array('act'=>'export')); ?>">-->
                        ...
                        <tr data-id="<?php echo $list['user_id']; ?>">
                            ...
                            <td align="left" class="">
                                <div style="text-align: center; width: 50px;">
                                    <a class="open" href="<?php echo U('editWithdrawals',array('id'=>$v[withdrawals_id])); ?>" target="blank">
                            ...
                            <td align="left" class="">
                                <div style="text-align: center; width: 100px;">已处理</div>
                            </td>
                            <td align="left" class="">
                            ...
                            <td align="center" class="">
                                <div style="text-align: center; width: 80px;"><?php echo $v['remark']; ?></div>
                            </td>
