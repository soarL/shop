<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:43:"./application/admin/view2/plugin\index.html";i:1525073028;s:44:"./application/admin/view2/public\layout.html";i:1499420862;}*/ ?>
<!doctype html>
<html>
<head>
        ...
        <div class="item-title">
            ...
            <ul class="tab-base nc-row">
               <!--  <li><a data-href="#tab_pay" class="<?php if($type == 'payment' or $type == ''): ?>current<?php endif; ?> tab" data-id=""><span>支付插件</span></a></li>
                ...
                <!-- li><a href="http://www.ZTfx.cn/articleList_cat_id_30.html" target="_blank"><span>云插件</span></a></li -->
            </ul>
        </div>
    </div>
    <!-- 操作说明 -->
                ...
                <table cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <th align="left" abbr="article_title" axis="col3" class="">
                            <div style="text-align: left; width: 120px;" class="">名称</div>
                        </th>
                        <th align="left" abbr="ac_id" axis="col4" class="">
                            <div style="text-align: left; width: 120px;" class="">描述</div>
                        </th>
                        <th align="left" abbr="article_show" axis="col5" class="">
                            <div style="text-align: center; width: 120px;" class="">图片</div>
                        </th>
