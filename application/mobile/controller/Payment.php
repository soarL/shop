...
class Payment extends MobileBase {
    ...
    public function  __construct() {   
        ...
        if(empty($this->pay_code))
            exit('pay_code 不能为空');        
        // 导入具体的支付类文件                
        include_once  "plugins/payment/{$this->pay_code}/{$this->pay_code}.class.php"; // D:\wamp\www\svn_ZTfx\www\plugins\payment\alipay\alipayPayment.class.php                       
    ...
    public function getPay(){
        ...
        // 服务器点对点 // http://www.ZTfx.cn/index.php/Home/Payment/notifyUrl        
        public function notifyUrl(){            
            $this->payment->response();            
            exit();
        }

        // 页面跳转 // http://www.ZTfx.cn/index.php/Home/Payment/returnUrl        
